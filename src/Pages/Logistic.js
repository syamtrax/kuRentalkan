...
const Logistic = () => {
  ...
  const addAddress = async () => {
    await addDoc(addressCollectionRef, { profil: newprofil, alamat: newalamat, notelp: newnotelp, uid: uid });
  ...
  const updateAddress = async (id) => {
    ...
    const newFields = { alamat: newalamat, profil: newprofil, notelp: newnotelp };
                        ...
                        return (
                          <div className="flex mb-3">
                            <div className="mt-4 w-full">
                              ...
                              <div className="pt-1 text-sm font-nunito">{a.notelp}</div>
                              <div className={a.alamat === '' ? "pt-1 text-sm text-red-600" : "pt-1 text-sm"}>
                                {a.alamat}
                              </div>
                            </div>
                          </div>
      ...
      <div className="container mx-auto">
        ...
        {penerimaan === 'Antar' ? <>
          <div className="flex mb-3">
            <div className="mt-4 w-4/5">
              <div className="pt-0 text-lg font-nunito font-bold">{alamat === '' ? '' : profil}</div>
              <div className="pt-1 text-sm font-nunito">{notelp}</div>
              <div className={alamat === '' ? "pt-1 text-sm text-red-600" : "pt-1 text-sm"}>
                {alamat === '' ? 'Pilih alamat!!' : alamat}
              </div>
            </div>
            <div className="mt-5 ml-5 font-nunito content-center items-end text-xs mb-5">
              <div>
                <button className="bg-transparent px-4 hover:bg-blue-500 text-gray-700 hover:text-white py-2 border-2 font-bold border-gray-200 hover:border-transparent rounded mt-1 w-40"
                  type="button"
                  onClick={() => setShowModal(true)}>Alamat</button>
              </div>
            </div>
          </div>
        </> : ''}
        <div className="flex border-t-2 mb-5">
            ...
            <div className="flex">
              ...
              <div className="ml-16 mt-4 font-nunito">
                ...
                <div className="text-sm text-gray-600">
                  ...
                  /> x {harga.toLocaleString('id-ID', {
                    style: 'currency',
                    currency: 'IDR',
                  })}</div>
                <div className="text-sm text-gray-600 pt-3">Sewa
                  <input
                    type='number'
                    name='hari'
                    id='hari'
          ...
          <div className="pl-14 border-l-2 mt-3 font-nunito">
            <div className="text-lg font-bold text-blue-700">Opsi Penerimaan</div>
            <div>
        ...
        <div className="flex border-t-2 border-b-2 pb-4">
          ...
          <div>
            <div className="pl-14 pt-8 font-bold text-lg">{((harga * jumlah * hari) + costongkir).toLocaleString('id-ID', {
              style: 'currency',
              currency: 'IDR',
            })}</div>
          </div>
        ...
        <div className="pl-20 flex p-5 mt-5 rounded-md border-2">
          ...
          <div>
            <input className="mt-2 text-lg bg-white "
              type="text"
              id="voucher"
              value={voucher}
              onChange={(event) => {
