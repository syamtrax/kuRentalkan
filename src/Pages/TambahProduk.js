...
const Usrs = () => {
  ...
  const createProduk = async () => {
    const docRef = await addDoc(CollectionRef, {name: newName, kategori: newKategori, merk: newMerk, tipe: newTipe, lokasi: newLokasi, harga: newHarga, operator: newOperator, deposit: newDeposit, kondisi: newKondisi, deskripsi: newDeskripsi, userid: newUserid})
