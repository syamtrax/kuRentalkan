      ...
      {uid !== "" ? (
        <div className="font-nunito fixed top-0 right-0 left-0 z-50 w-full shadow-xl bg-white h-24">
          <div className="mx-auto container flex mt-4 ">
            ...
            <div className=" px-6 py-2 mt-3 mr-20 border border-gray-200 bg-white max-w-lg max-h-min border-opacity-75 rounded-lg shadow-lg w-full space-x-6 flex items-center transform transition duration-300 ">
              <input
                type="search"
              ...
              />
              <button className="focus:outline-none transform transition duration-300 md:hover:scale-105">
